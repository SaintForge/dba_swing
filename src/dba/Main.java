...
class SettingsData
{
	...
	public void setMtmPort(String mtpPort) {
...
class DBForm
{
	...
	DBForm(SettingsData settings)
	{
		...
		this.panel.add(tableSearch,  new GridBagConstraints(0, 0, 100, 1, 1.0, 0.01, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 100, 0));

		JTextField fieldSearch = new JTextField();
		this.panel.add(fieldSearch,  new GridBagConstraints(1, 0, 100, 1, 1.0, 0.01, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 100, 0));

		this.panel.add(tableList,  new GridBagConstraints(0, 1, 1, 1, 1.0, 0.7, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		this.panel.add(tableInfo,  new GridBagConstraints(0, 2, 1, 1, 1.0, 0.35, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

        this.panel.add(fieldList,  new GridBagConstraints(1, 1, 1, 1, 1.0, 0.7, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

        this.panel.add(fieldInfo,  new GridBagConstraints(1, 2, 1, 1, 1.0, 0.35, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
